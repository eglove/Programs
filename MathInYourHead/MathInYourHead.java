public class MathInYourHead {
    ...
    public static void level0(int level) {
        ...
        //		  314*11=3454
        System.out.println("This is a fun one, multiply a 3 digit number by"
                + " 11!");
    ...
    public static void help(int h) {
        switch (h) {
            case 0:
                System.out.println("Add the first number to the second " +
                ...
                break;
            case 1:
                System.out.println("Add the two digits, place that sum " +
                        "in the middle.\n32*11=253\nIf the sum is greater than 9, " +
                        "the 1 carries over to the first numbers.\n85*11=935");
                break;
            case 2:
                System.out.println("Add the first two digits, then add " +
                        "the second two. Put the sum in the middle.\n" +
                        "314*11=3454");
                break;
            case 3:
                System.out.println("Multiply the first digit by the next " +
